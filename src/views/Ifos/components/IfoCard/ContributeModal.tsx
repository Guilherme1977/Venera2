  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      ...
      <Flex justifyContent="space-between" mb="24px">
        <Button fullWidth variant="secondary" onClick={onDismiss} mr="8px" className="btn_yellow">
          Cancel
        </Button>
        <Button
      ...
      <LinkExternal
        href="https://exchange.veneraswap.com/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82"
        style={{ margin: 'auto' }}
      >
        {`Get ${currency}`}
      </LinkExternal>
