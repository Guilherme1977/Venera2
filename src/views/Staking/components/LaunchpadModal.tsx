      ...
      <CardBody className="modal_card">
        ...
        <CardMidContent color="secondary">
         <ul className="coin_ul_desc">
             <li>
                 <div>
                 <Text color="color_purple" className="coin_desc_li_one">Your VSW Balance</Text>
                 </div>
                 <div>
                 <Text color="color_balck_grey" className="coin_name_title">N/A vSW</Text>
                 </div>
             </li>
             <li>
                 <div>
                 ...
                 <div>
                 <Text color="color_balck_grey" className="coin_name_title">550 VSW</Text>
                 </div>
             </li>
             <li>
                 <div>
        ...
        <div>
            ...
            <div className="max_buy_sec">
              <Button className="btn_yellow">Max</Button>
              <Button className="btn_yellow">Buy</Button>
              </div>
          </div>
          <div>
            ...
            <div className="max_buy_sec_1">
              <Button className="btn_yellow">Claim</Button>
