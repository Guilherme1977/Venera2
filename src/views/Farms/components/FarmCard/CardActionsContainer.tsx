...
const CardActions: React.FC<FarmCardActionsProps> = ({ farm, ethereum, account }) => {
  ...
  const renderApprovalOrStakeButton = () => {
    return isApproved ? (
      ...
      <Button className="btn_grad_yel" mt="8px" fullWidth disabled={requestedApproval} onClick={handleApprove}>
  ...
  return (
    <Action>
      ...
      {!account ? <UnlockButton mt="8px" fullWidth className="btn_grad_yel" /> : renderApprovalOrStakeButton()}
    </Action>
  )
}
