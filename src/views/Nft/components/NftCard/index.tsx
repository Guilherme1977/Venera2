    ...
    <Card isActive={walletOwnsNft}>
      ...
      <CardBody>
        ...
        {isInitialized && walletOwnsNft && (
          <Button className="btn_yellow" fullWidth variant="secondary" mt="24px" onClick={onPresentTransferModal}>
            {TranslateString(999, 'Transfer')}
          </Button>
        )}
        {isInitialized && walletCanClaim && isSupplyAvailable && (
          <Button className="btn_yellow" fullWidth onClick={onPresentClaimModal} mt="24px">
            {TranslateString(999, 'Claim this NFT')}
          </Button>
        )}
        {isInitialized && canBurnNft && walletOwnsNft && (
          <Button className="btn_yellow" variant="danger" fullWidth onClick={onPresentBurnModal} mt="24px">
